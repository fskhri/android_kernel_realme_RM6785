...
int panel_serial_number_read(char cmd, int num)
{
	...
	struct drm_device *ddev = get_drm_device();
        ...
        mtk_ddp_comp_io_cmd(comp, NULL, GET_PANEL_NAME,
				    &panel_name);
        printk("panelname=%s\n",panel_name);
	if (!strcmp(panel_name, "oppo20131_boe_nt37800_1080p_dsi_cmd"))
          para[0] = BOE_PANEL_SERIAL_NUM_REG;
        if ((!strcmp(panel_name, "oppo20131_samsung_ana6705_1080p_dsi_cmd,lcm")) || (!strcmp(panel_name, "oppo20601_samsung_sofe03f_m_1080p_dsi_cmd")))
          para[2] = 11;
        while (count > 0) {
                comp->funcs->io_cmd(comp, NULL, DSI_READ, para);
                count--;
	    if ((!strcmp(panel_name, "oppo20131_samsung_ana6705_1080p_dsi_cmd,lcm"))
			|| (!strcmp(panel_name, "oppo20601_samsung_sofe03f_m_1080p_dsi_cmd"))) {
            ...
            } else if (!strcmp(panel_name, "oppo20131_boe_nt37800_1080p_dsi_cmd")) {
		panel_serial_info.reg_index = 0;
                panel_serial_info.month     = para[panel_serial_info.reg_index] & 0x0F;
