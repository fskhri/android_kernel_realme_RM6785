...
#include "../mediatek/mtk_corner_pattern/oppo20131_BOE_NT37800_data_hw_roundedpattern.h"
#endif
...
static int oppo_lcm_dc_backlight(void *dsi, dcs_write_gce cb,void *handle,unsigned int level,int hbm_en)
{
	...
	if (!oplus_dc_enable_real || hbm_en || level < 4 || aod_state) {
		goto dc_disable;
	}
			      ...
			      dcs_write_gce cb, void *handle, bool en)
{
	...
	pr_err("boe lcm: debug for oppo_display_brightness= %ld, en=%u\n", oppo_display_brightness, en);
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	register_device_proc("lcd", "NT37800", "boe_nt37800_2048");
	ctx->hbm_en = false;
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oppo20131_boe_nt37800_1080p_dsi_cmd",
		.owner = THIS_MODULE,
