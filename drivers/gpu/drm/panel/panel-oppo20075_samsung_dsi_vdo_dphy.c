...
/*Jian.Zhou@PSW.MM.Display.LCD.Stability 2020/09/28, add ROUND-CORNER parameters file for 20075R*/
#ifdef CONFIG_MTK_ROUND_CORNER_SUPPORT
#include "../mediatek/mtk_corner_pattern/oppo20075_AMS644VA04_data_hw_roundedpattern.h"
#endif
...
static struct LCM_setting_table lcm_aod_to_normal[] = {
	...
	{REGFLAG_CMD,22,{0xB1, 0xE8, 0x00, 0x04, 0x04, 0xFF, 0x02, 0x00, 0x00, 0xFF, 0x14, 0xFF, 0xDE, 0xFD, 0x00, 0xE0, 0xFD, 0xEE, 0x00, 0xFF, 0xFF, 0xFF}},
...
/* #endif */ /* OPLUS_BUG_STABILITY */
	...
	lcm_dcs_write_seq_static(ctx, 0xB1, 0xE8, 0x00, 0x04, 0x04, 0xFF, 0x02, 0x00, 0x00, 0xFF, 0x14, 0xFF, 0xDE, 0xFD, 0x00, 0xE0, 0xFD, 0xEE, 0x00, 0xFF, 0xFF, 0xFF);
           ...
           void *handle, unsigned int level)
{
	...
	bl_tb0[1] = oppo_display_brightness >> 8;
	bl_tb0[2] = oppo_display_brightness & 0xFF;

	oplus_lcm_dc_backlight(dsi,cb,handle, oppo_display_brightness, 1);
	cb(dsi, handle, bl_tb0, ARRAY_SIZE(bl_tb0));
...
#ifndef VENDOR_EDIT
/* LiPing-m@PSW.MM.DisplayDriver.LCD, 2019/11/27, modify for LCD color case ALPS04900040 */
...
static int lcm_probe(struct mipi_dsi_device *dsi)
{
	...
	oplus_dc_threshold = OPPO_DC_BACKLIGHT_THRESHOLD;
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-oppo20075_samsung_dsi_vdo_dphy",
		.owner = THIS_MODULE,
