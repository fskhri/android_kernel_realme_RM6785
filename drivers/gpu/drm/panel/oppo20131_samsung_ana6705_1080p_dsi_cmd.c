...
#include "../mediatek/mtk_corner_pattern/oppo20131_AMB655XL08_data_hw_roundedpattern.h"
#endif
...
static struct LCM_setting_table lcm_aod_to_normal[] = {
	...
	{REGFLAG_CMD,7,{0xB7, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06}},
	{REGFLAG_CMD,3,{0xF0, 0xA5, 0xA5}},
	/* seed settings */
...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	/* ELVSS FIX */
	lcm_dcs_write_seq_static(ctx,0xF0, 0x5A, 0x5A);
	lcm_dcs_write_seq_static(ctx,0xB0, 0x1F);
	lcm_dcs_write_seq_static(ctx,0xB7, 0x06, 0x06, 0x06, 0x06, 0x06, 0x06);
	lcm_dcs_write_seq_static(ctx,0xF0, 0xA5, 0xA5);
	/* ACL off */
	lcm_dcs_write_seq_static(ctx,0xF0, 0x5A, 0x5A);
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "oppo20131_samsung_ana6705_1080p_dsi_cmd,lcm",
		.owner = THIS_MODULE,
