...
/* Add by yangshounan for register device info at 20200506 */
#define DEVICE_VERSION_IMX398    "imx398"
...
#ifdef OPLUS_FEATURE_CAMERA_COMMON
/*yangshounan 2020/05/06,modify for different module*/
		...
		do {
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				#ifdef OPLUS_FEATURE_CAMERA_COMMON
				/* yangshounan@Camera.Driver add for imx398 second resource 20200506*/
				module_id = read_module_id();
				gmodule_id = module_id;
				read_eeprom_SN();
				if(deviceInfo_register_value == 0x00){
					Oplusimgsensor_Registdeviceinfo("Cam_b", DEVICE_VERSION_IMX398, module_id);
