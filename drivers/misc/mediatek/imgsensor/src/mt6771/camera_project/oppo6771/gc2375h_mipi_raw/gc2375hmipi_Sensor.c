...
/*pankaj.kumar@Camera.Driver 20200911 add for oppo_project from oplus*/
			...
			*sensor_id = return_sensor_id();
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				if (deviceInfo_register_value == 0x00) {
					Oplusimgsensor_Registdeviceinfo("Cam_b_s", DEVICE_VERSION_GC2375H, imgsensor_info.module_id);
