        ...
        *sensor_id = 0xFFFFFFFF;
    	...
    	while (imgsensor_info.i2c_addr_table[i] != 0xff) {
			...
			if (deviceInfo_register_value == 0x00) {
				Oplusimgsensor_Registdeviceinfo("Cam_r3", DEVICE_VERSION_GC02M0, imgsensor_info.module_id);
...
UINT32 GC02M0_MIPI_MONO_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
