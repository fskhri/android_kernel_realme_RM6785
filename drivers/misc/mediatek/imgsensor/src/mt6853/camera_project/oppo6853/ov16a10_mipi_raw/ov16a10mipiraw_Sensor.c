...
/*Wenjun.Wu@Camera.Driver add for 20001 ,20200420 */
#define DEVICE_VERSION_OV16A10     "ov16a10"
//extern void register_imgsensor_deviceinfo(char *name, char *version, u8 module_id);
//static kal_uint8 deviceInfo_register_value = 0x00;
#endif

/* Shipei.Chen@Cam.Drv, 20200407, sensor porting*/
#ifdef OPLUS_FEATURE_CAMERA_COMMON
			...
			*sensor_id = return_sensor_id();
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				/*
						...
						register_imgsensor_deviceinfo("Cam_r0", DEVICE_VERSION_OV16A10, imgsensor_info.module_id);
