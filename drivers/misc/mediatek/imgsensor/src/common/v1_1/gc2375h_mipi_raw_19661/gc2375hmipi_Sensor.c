...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC2375H_SENSOR_ID_19661,        //record sensor id defined in Kd_imgsensor.h
	#ifdef VENDOR_EDIT
...
UINT32 GC2375H_MIPI_RAW_19661_SensorInit(PSENSOR_FUNCTION_STRUCT *pfFunc)
{
