...
static imgsensor_info_struct imgsensor_info = {
	.sensor_id = PASCALA_TRULY_MAIN_S5KGM1SP_SENSOR_ID,
			...
			if (*sensor_id == 0x08D1) {
				...
				if (module_id == 0x02 && vcm_id == 0x5C) {//truly
					...
					*sensor_id = 0xFFFFFFFF;
					pr_err("truly match fail");
					return ERROR_SENSOR_CONNECT_FAIL;
				}
			}
			pr_err("truly Read sensor id fail, id: 0x%x ensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		retry = 2;
