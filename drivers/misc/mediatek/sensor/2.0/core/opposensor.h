...
#define SENSOR_TYPE_OPPO_ACTIVITY_RECOGNITION          (OPLUS_VIRTAUL_SENSOR_START + 8)
...
/* end sensor type */
#define SENSOR_TYPE_SENSOR_MAX                         (SENSOR_TYPE_ELEVATOR_DETECT +1)
...
#define ID_SAR_MODEM            (ID_OPPO_BASE + SENSOR_TYPE_SAR_MODEM - 1)
...
//#endif //OPLUS_FEATURE_ELEVATOR_DETECT
/* end sensor ID */
#define ID_SENSOR_MAX    (ID_ELEVATOR_DETECT + 1)
