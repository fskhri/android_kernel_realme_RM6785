...
static void oplus_app_monitor_update_top_push_app(struct app_monitor_app_info_st *app_info)
{
	...
	/*compare with the min record*/
	if (app_info->push_count >
			top_app_push_info.app_push_info[max_index].push_count) {
...
static struct app_monitor_app_info_list_node_st
*oplus_app_monitor_get_app_info_by_uid(u32 uid)
{
...
void oplus_app_monitor_update_flow_stat(struct app_monitor_app_info_list_node_st    *app_info_node, const  struct sk_buff *skb, int send)
{
	if (send) {
...
void oplus_app_monitor_update_retrans_stat(struct app_monitor_app_info_list_node_st *app_info_node, const  struct sk_buff *skb)
{
